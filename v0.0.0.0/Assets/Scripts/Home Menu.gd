...
func _on_NavigationButton9_pressed():
	$SystemSettingsStartupAudio.play()
	await get_tree().create_timer(0.5).timeout
	get_tree().change_scene_to_file("res://File System.tscn")

func _on_NavigationButton9_mouse_entered():
	var NavigationButton9 = get_node("NavigationContainer/NavigationButton9/NavigationButton1Label9")
	NavigationButton9.show()
	$MoveSelectorAudio.play()

func _on_NavigationButton9_mouse_exited():
	var NavigationButton9 = get_node("NavigationContainer/NavigationButton9/NavigationButton1Label9")
	NavigationButton9.hide()
...
func _on_NavigationButton6_pressed():
	$SystemSettingsStartupAudio.play()
	await get_tree().create_timer(0.5).timeout
	get_tree().change_scene_to_file("res://System Settings.tscn")
